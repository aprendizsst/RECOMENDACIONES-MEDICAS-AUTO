window.APP_CONFIG = Object.freeze({
  ...
  companyName: "JER S.A.",
  version: "2026.09.04-github-pages-v10.13",
  pipelineVersion: "2026-09-04.10.13-ai-batch-recalibrated",
  aiValidationVersion: "2026-09-04.10.13-material-conflict-audit",
  documentEngineVersion: "2026-09-03.10.7-compact-letter-full-sheet-sync",
  requiredBackendVersion: "2026.09.04-v10.13-ai-batch-recalibrated",
  ...
  batchGeminiModel: "gemini-2.5-flash",
  maxGeminiPdfMb: 18,
  maxBatchFiles: 50,
  maxEmailRawBatchMb: 14,
  localConcurrency: 4,
  aiConcurrency: 2,
  aiRecoveryDelayMs: 12000,
